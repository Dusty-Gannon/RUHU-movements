...
## Overview
 The final dataset will include the frequency of hummingbird movements among different RFID readers across the HJA meadows in each of four years. We combine information on distances between readers, cover-type in which each reader was placed, and the proportion of intervening forest.
 
 
#### Raw data
  
  The raw data include six columns of data and one row for each record of a PIT tag as passed through the reader. The fields include:
...
* Meadow complex $\in$ {CM,LOM,M1,M2}

* Reader position within the complex $\in$ {N,S,E,W,C} (sometimes SE or SW, etc.)
