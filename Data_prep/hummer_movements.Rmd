...
## Overview
 The final dataset will include the frequency of hummingbird movements among different RFID readers across the HJA meadows in each of four years. We combine these movements with information on distances between readers, cover-type in which each reader was placed, and the proportion of intervening forest.
